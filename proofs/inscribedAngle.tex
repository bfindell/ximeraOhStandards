...
\item She divides that equation by $\answer{2}$ to conclude that $m\angle ABC = x+y = \answer{90}$ degrees.  
...
Because $z$ is the measure of an angle exterior to $\triangle \answer{APB}$, it is equal to the sum of the measures of the \wordChoice{\choice{opposite}\choice{adjacent}\choice[correct]{remote interior}\choice{alternate interior}} angles.  In other words $z=2x$.  
