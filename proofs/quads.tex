...
Proof:  Because $B$ and $D$ are each $\answer[format=string]{equidistant}$ from $A$ and $C$, they each must lie on the perpendicular bisector of segment $\answer[format=string]{AC}$, which implies that 
