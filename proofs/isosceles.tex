...
\fixnote{Taylor's claim, the prompt, and the choices below need attention.  Simon's figure suggests congruence by ``SSAS,'' which might indicate that too much is being assumed.  Would that make sense as a distractor?}
...
\choice[correct]{Taylor is correct, and the perpendicular bisector should not be used to complete this proof.}
