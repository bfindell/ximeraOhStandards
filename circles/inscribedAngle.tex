...
\begin{enumerate}
\item Keeping points $A$ and $C$ fixed, when point $B$ moves, $m\angle ABC$ \wordChoice{\choice{increases}\choice{stays the same}\choice{decreases}\choice{varies widely}}.  
