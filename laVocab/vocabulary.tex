...
\begin{question}
Suppose in matrix $E$, two conditions hold:
\begin{enumerate}
...
\end{enumerate}
The matrix is (row) $\answer[format=string]{echelon form}$.  (Hint: two words.)
...
$AB=I_n$ and $BA=I_n$, then $A$ is said to be $\answer[format=string]{invertible}$, and the matrix $B$ is called the $\answer[format=string]{inverse}$ of $A$. If there is no such matrix $B$, the $A$ is said to be $\answer[format=string]{singular}$, or noninvertible. 
\end{question} 
